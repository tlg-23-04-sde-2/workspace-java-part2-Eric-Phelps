...
public class EmployeeFactoryTest {
     ...
     */
    @Test
    public void createEmployee_shouldReturnHourlyEmployee_typeSE() {
        Employee emp = EmployeeFactory.createEmployee(seMap);

        assertEquals(SalariedEmployee.class, emp.getClass());
        verifyCommonProperties(emp);
        //need to down cast the reference of emp to a mores specific type of salaried employee
        SalariedEmployee semp = (SalariedEmployee) emp;
        assertEquals(50000.0, ((SalariedEmployee) emp).getSalary(),.001);
    ...
    public void createEmployee_shouldReturnHourlyEmployee_typeHE() {
        ...
        assertEquals(50, ((HourlyEmployee) emp).getRate(),.001);
        assertEquals(40, ((HourlyEmployee) emp).getHours(),.001);
    }
    ...
    public void createEmployee_shouldThrowIllegalArgumentException_whenInvalidType() {
        ...
        EmployeeFactory.createEmployee(map); //this should trigger the exception.
    }
}